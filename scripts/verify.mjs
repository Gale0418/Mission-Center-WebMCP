...
if (!html.includes('prefers-reduced-motion') && !(await readFile(path.join(root,'assets/app.css'),'utf8')).includes('prefers-reduced-motion')) failures.push('reduced-motion handling missing');
